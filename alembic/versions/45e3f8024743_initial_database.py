...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("code", sa.String(), nullable=True),
        sa.Column(
            "kind", sa.Enum("basin", "watershed", name="region_kinds"), nullable=True
        ),
        sa.Column(
            "boundary",
            Geometry(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["data_reference"],
            [f"{salmon_schema}.reference.reference_id"],
        ),
        sa.ForeignKeyConstraint(
            ["precise_time_reference"],
            [f"{salmon_schema}.reference.reference_id"],
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            [f"{salmon_schema}.conservation_unit.conservation_unit_id"],
        ),
        sa.ForeignKeyConstraint(
            ["migration_time_range"],
            [f"{salmon_schema}.phenology.phenology_id"],
        ),
        sa.ForeignKeyConstraint(
            ["spawn_time_range"],
            [f"{salmon_schema}.phenology.phenology_id"],
        ...
        sa.ForeignKeyConstraint(
            ["taxon_id"],
            [f"{salmon_schema}.taxon.taxon_id"],
        ),
